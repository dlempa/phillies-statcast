...
st.caption("Tracking the biggest Phillies home runs and standout Statcast moments throughout the season.")
...
value, player = format_metric(metrics["longest_hr"], "ft")
card_1.metric("Longest HR of season", value, player)
value, player = format_metric(metrics["most_hrs"], "HR")
card_2.metric("Most HRs by a Phillies player", value, player)
value, player = format_metric(metrics["hardest_hr"], "mph")
card_3.metric("Hardest-hit HR", value, player)
value, player = format_metric(metrics["hardest_ball"], "mph")
